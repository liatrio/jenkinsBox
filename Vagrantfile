...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell",
    inline: "sudo wget -O /etc/yum.repos.d/jenkins.repo http://pkg.jenkins-ci.org/redhat/jenkins.repo"
  config.vm.provision "shell",
    inline: "sudo rpm --import https://jenkins-ci.org/redhat/jenkins-ci.org.key"
  config.vm.provision "shell",
